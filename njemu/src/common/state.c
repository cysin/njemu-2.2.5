...
#if (EMU_SYSTEM == CPS1)
static const char *current_version_str = "CPS1SV22";
#elif (EMU_SYSTEM == CPS2)
static const char *current_version_str = "CPS2SV22";
#elif (EMU_SYSTEM == MVS)
static const char *current_version_str = "MVS_SV22";
#elif (EMU_SYSTEM == NCDZ)
static const char *current_version_str = "NCDZSV22";
#endif
